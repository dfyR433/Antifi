...
void beacon_setup() {
    ...
    // Initialize WiFi in AP mode for beacon transmission
    WiFi.mode(WIFI_AP);
    delay(100);
    ...
    // Disable power saving for better transmission
    ...
    // Set higher TX power
    esp_wifi_set_max_tx_power(82);  // ~19.5dBm
